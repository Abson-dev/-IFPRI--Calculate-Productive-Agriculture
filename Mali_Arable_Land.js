var Hansen_GFC = ee.Image("UMD/hansen/global_forest_change_2020_v1_8"),
    ...
    GFSAD30AFCE_2015_ML_1 = ee.Image("projects/ee-aboubacarhema94/assets/Mali/GFSAD30AFCE_2015_ML_1"),
    GFSAD30AFCE_2015_ML_2 = ee.Image("projects/ee-aboubacarhema94/assets/Mali/GFSAD30AFCE_2015_ML_2"),
    GFSAD30AFCE_2015_ML_3 = ee.Image("projects/ee-aboubacarhema94/assets/Mali/GFSAD30AFCE_2015_ML_3"),
    GFSAD30AFCE_2015_ML_4 = ee.Image("projects/ee-aboubacarhema94/assets/Mali/GFSAD30AFCE_2015_ML_4"),
    GFSAD30AFCE_2015_ML_5 = ee.Image("projects/ee-aboubacarhema94/assets/Mali/GFSAD30AFCE_2015_ML_5"),
    ImperviousSurfaceGMIS = ee.Image("projects/ee-aboubacarhema94/assets/Mali/MLI_gmis_impervious_surface_percentage_geographic_30m"),
    ProtectedAreaPolygons = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Mali/ProtectedAreaPolygons"),
    GAUL_adm0 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Mali/gadm41_MLI_0"),
    GAUL_adm1 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Mali/gadm41_MLI_1"),
    GAUL_adm2 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Mali/gadm41_MLI_2"),
    geometry = ee.Geometry.Polygon(
        [[[-14.89303956178829, 27.27678130139402],
          [-14.89303956178829, 7.779229340858256],
          [7.0796166882117095, 7.779229340858256],
          [7.0796166882117095, 27.27678130139402]]], null, false);
...
//Description: Scripts Aggregates Cleared Forest and Cropland datasets, masking  permanent water,
          //   and imprevious surfaces to identify arable land in Mali at 30m resolution
...
//Get AOI of Interest
////Import GADM data for Mali (https://gadm.org/data.html)
var adm0_AOI = GAUL_adm0;
var adm2_AOI = GAUL_adm2;
Map.addLayer(adm2_AOI, {color: 'purple'}, 'Mali Admin2 Boundaries');

//////////////////////////////////////////////////////////////////////////////////////////////////////

//Imported GFSAD30AFCE Rasters --> 30m 
//Downloaded from EarthExplorer over Mali
  //Download URL: https://search.earthdata.nasa.gov/search
  //Dataset URL: https://lpdaac.usgs.gov/products/gfsad30afcev001/
var GFSAD_1 = GFSAD30AFCE_2015_ML_1;
var GFSAD_2 = GFSAD30AFCE_2015_ML_2;
var GFSAD_3 = GFSAD30AFCE_2015_ML_3;
var GFSAD_4 = GFSAD30AFCE_2015_ML_4;
var GFSAD_5 = GFSAD30AFCE_2015_ML_5;

//CLip Images to Mali Extent --> Mask 
...
var clipGFSAD_5 = GFSAD_5.clip(adm0_AOI);
//Create Image Collection so it can be mosaiced together --> use quality mosaic to get highest 
var GFSAD = ee.ImageCollection([clipGFSAD_1, clipGFSAD_2,clipGFSAD_3, clipGFSAD_4,clipGFSAD_5]).mosaic();
var bin = {
  bands: ['b1'],
  min: 0,
  max: 2,
