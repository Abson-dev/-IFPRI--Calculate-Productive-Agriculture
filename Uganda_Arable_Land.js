var Hansen_GFC = ee.Image("UMD/hansen/global_forest_change_2020_v1_8"),
    ...
    GFSAD30AFCE_2015_UGA_1 = ee.Image("projects/ee-aboubacarhema94/assets/Uganda/GFSAD30AFCE_2015_UGA_1"),
    GFSAD30AFCE_2015_UGA_2 = ee.Image("projects/ee-aboubacarhema94/assets/Uganda/GFSAD30AFCE_2015_UGA_2"),
    GFSAD30AFCE_2015_UGA_3 = ee.Image("projects/ee-aboubacarhema94/assets/Uganda/GFSAD30AFCE_2015_UGA_3"),
    ImperviousSurfaceGMIS = ee.Image("projects/ee-aboubacarhema94/assets/Uganda/UGA_gmis_impervious_surface_percentage_geographic_30m"),
    GAUL_adm0 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Uganda/gadm41_UGA_0"),
    GAUL_adm1 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Uganda/gadm41_UGA_1"),
    GAUL_adm2 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Uganda/gadm41_UGA_2"),
    ProtectedAreaPoints = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Uganda/ProtectedAreaPoints"),
    ProtectedAreaPolygons = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Uganda/ProtectedAreaPolygons"),
    geometry = ee.Geometry.Polygon(
        [[[27.975986521888196, 5.301322577001104],
          [27.975986521888196, -2.73205339964617],
          [36.721103709388196, -2.73205339964617],
          [36.721103709388196, 5.301322577001104]]], null, false);
...
//Description: Scripts Aggregates Cleared Forest and Cropland datasets, masking  permanent water,
          //   and imprevious surfaces to identify arable land in Uganda at 30m resolution
...
//Get AOI of Interest
////Import GADM data for Uganda (https://gadm.org/data.html)
var adm0_AOI = GAUL_adm0;
var adm2_AOI = GAUL_adm1;
Map.addLayer(adm2_AOI, {color: 'purple'}, 'Uganda Admin2 Boundaries');

//////////////////////////////////////////////////////////////////////////////////////////////////////

//Imported GFSAD30AFCE Rasters --> 30m 
//Downloaded from EarthExplorer over Uganda
  //Download URL: https://search.earthdata.nasa.gov/search
  //Dataset URL: https://lpdaac.usgs.gov/products/gfsad30afcev001/
var GFSAD_1 = GFSAD30AFCE_2015_UGA_1;
var GFSAD_2 = GFSAD30AFCE_2015_UGA_2;
var GFSAD_3 = GFSAD30AFCE_2015_UGA_3;

//CLip Images to Uganda Extent --> Mask 
