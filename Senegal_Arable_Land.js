var Hansen_GFC = ee.Image("UMD/hansen/global_forest_change_2020_v1_8"),
    ...
    ImperviousSurfaceGMIS = ee.Image("projects/ee-aboubacarhema94/assets/Senegal/SEN_gmis_impervious_surface_percentage_geographic_30m"),
    GFSAD30AFCE_2015_SEN = ee.Image("projects/ee-aboubacarhema94/assets/Senegal/GFSAD30AFCE_2015_SEN"),
    geometry = ee.Geometry.Polygon(
        [[[-18.574699942344584, 17.29256169361102],
          [-18.574699942344584, 11.614171696847718],
          [-10.378899161094584, 11.614171696847718],
          [-10.378899161094584, 17.29256169361102]]], null, false),
    GAUL_adm0 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Senegal/gadm41_SEN_0"),
    GAUL_adm1 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Senegal/gadm41_SEN_1"),
    GAUL_adm2 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Senegal/gadm41_SEN_2"),
    ProtectedAreaPoints = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Senegal/ProtectedAreaPoints"),
    ProtectedAreaPolygons = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Senegal/ProtectedAreaPolygons");
...
//Description: Scripts Aggregates Cleared Forest and Cropland datasets, masking  permanent water,
          //   and imprevious surfaces to identify arable land in Senegal at 30m resolution
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//Variables 
Map.setCenter(-16,15,6.5);
var adm0_name = "Senegal"; 
...
//Get AOI of Interest
////Import GADM data for Senegal (https://gadm.org/data.html)
var adm0_AOI = GAUL_adm0;
var adm2_AOI = GAUL_adm2;
Map.addLayer(adm2_AOI, {color: 'purple'}, 'Senegal Admin2 Boundaries');

//////////////////////////////////////////////////////////////////////////////////////////////////////

//Imported GFSAD30AFCE Rasters --> 30m 
//Downloaded from EarthExplorer over Senegal
  //Download URL: https://search.earthdata.nasa.gov/search
  //Dataset URL: https://lpdaac.usgs.gov/products/gfsad30afcev001/
var GFSAD_1 = GFSAD30AFCE_2015_SEN;

//CLip Images to Senegal Extent --> Mask 
