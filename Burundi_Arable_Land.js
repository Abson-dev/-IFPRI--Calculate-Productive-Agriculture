var Hansen_GFC = ee.Image("UMD/hansen/global_forest_change_2020_v1_8"),
    ...
    GFSAD30AFCE_2015_BDI_1 = ee.Image("projects/ee-aboubacarhema94/assets/Burindi/GFSAD30AFCE_2015_BDI_1"),
    GFSAD30AFCE_2015_BDI_2 = ee.Image("projects/ee-aboubacarhema94/assets/Burindi/GFSAD30AFCE_2015_BDI_2"),
    ProtectedAreaPoints = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Burindi/ProtectedAreaPoints"),
    ProtectedAreaPolygons = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Burindi/ProtectedAreaPolygons"),
    GAUL_adm0 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Burindi/gadm41_BDI_0"),
    GAUL_adm1 = ee.FeatureCollection("projects/ee-aboubacarhema94/assets/Burindi/gadm41_BDI_1"),
    ImperviousSurfaceGMIS = ee.Image("projects/ee-aboubacarhema94/assets/Burindi/BDI_gmis_impervious_surface_percentage_geographic_30m"),
    geometry = ee.Geometry.Polygon(
        [[[28.583984374999993, -2.1541014604566118],
          [28.583984374999993, -4.62151339541023],
          [31.176757812499993, -4.62151339541023],
          [31.176757812499993, -2.1541014604566118]]], null, false);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//Variables 
Map.setCenter(31,-3,7.5);
var adm0_name = "Burundi"; 
...
//Get AOI of Interest
////Import GADM data for Burundi (https://gadm.org/data.html)
var adm0_AOI = GAUL_adm0;
var adm2_AOI = GAUL_adm1;
Map.addLayer(adm2_AOI, {color: 'purple'}, 'Burundi Admin2 Boundaries');

//////////////////////////////////////////////////////////////////////////////////////////////////////

//Imported GFSAD30AFCE Rasters --> 30m 
//Downloaded from EarthExplorer over Burundi
  //Download URL: https://search.earthdata.nasa.gov/search
  //Dataset URL: https://lpdaac.usgs.gov/products/gfsad30afcev001/
var GFSAD_1 = GFSAD30AFCE_2015_BDI_1;
var GFSAD_2 = GFSAD30AFCE_2015_BDI_2;

//CLip Images to Burundi Extent --> Mask 
