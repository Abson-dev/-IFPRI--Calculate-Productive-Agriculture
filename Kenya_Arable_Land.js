var Hansen_GFC = ee.Image("UMD/hansen/global_forest_change_2020_v1_8"),
    ...
    dataset = ee.Image("UMD/hansen/global_forest_change_2015_v1_3"),
    ...
    geometry = ee.Geometry.Polygon(
        [[[33.487619647710574, 5.262415464986558],
          ...
          [43.309396991460574, 5.262415464986558]]], null, false),
...
*/
var GMIS_ImperviousSurface = ImperviousSurfaceKEN;
...
//////////////////////////////////////////////////////////////////////////////////////////////////
var PAG_KEN_mosaic = PAG_KEN_mosaic.eq(1).selfMask()
var bin = {
  bands: ["b1"],
  min: 0,
  max: 1,
...
Map.addLayer(PAG_KEN_mosaic, bin, adm0_name + ' Fernando');
//////////////////////////////////////////////////////////////////////////////////////////////////
